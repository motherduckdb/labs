-- v2 analytics views for DABstep
-- Creates pre-joined views that simplify common fee-related queries.
-- NULL values in fee rules act as wildcards (match any value).

CREATE SCHEMA IF NOT EXISTS analytics;

-- Drop old/removed names (historical)
