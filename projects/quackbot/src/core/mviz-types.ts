 ...
 * streaming detector (`src/core/mviz-fence.ts`) gates on this list — anything not
 * here streams through as a plain code block instead of an inline render.
 *
 * To widen the surface, add a type here and teach it in `src/core/system-prompt.ts`.
