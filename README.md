...
| [`motherduck-oauth-nextjs`](./projects/motherduck-oauth-nextjs/) | Minimal BI-style Next.js app — sign in with MotherDuck (OAuth 2.1 + PKCE), browse the Dives you can access, and view them embedded inline. |
