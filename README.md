...
| [`nba-box-scores`](./projects/nba-box-scores/) | NBA box scores on a MotherDuck-native stack: a Python ingest pipeline run as scheduled Flights (`flight/`) and a consolidated frontend built as a MotherDuck Dive (`dive/`). |
